...
namespace LDBotV2
{
    ...
    public class ToolHelper
    {
        ...
        public static void checkValidConfigurations()
        {
            ...
            try
            {
                ...
                {
                    raiseOnWriteLog("Vui lòng đợi tool tìm thư mục cài đặt LD Player");
    ...
    public static class HardwareInfo
    {
        ...
        {
            return getKey(DataHelper.Md5Encode(GetProcessorId() + GetHDDSerialNo()));
        }
        public static string getKey(string channel)
        {
            return (channel + "pimbot").GetHashCode().ToString("X").ToLower();
        }
    }
}
